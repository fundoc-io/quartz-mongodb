...
class ExpiryCalculatorTest extends Specification {
	...
	@Shared
	def defaultInstanceId = "test instance"
	@Shared
	def jobTimeoutMillis = 100l
	@Shared
	def triggerTimeoutMillis = 10000l
	@Shared
	def isClustered = true
