...
import io.fundoc.quartz.mongodb.util.SerialUtils;
...
public class JobDataConverter {
     ...
     *
     * @param base64Preferred
     *            if preferred way to store job details is {@code base64}.
     */
    ...
    /**
     * Converts from job data map to document. Depending on config, job data map can be stored as a {@code base64}
     * encoded or plain object.
     *
     * @param from
     *            {@link JobDataMap} to convert from.
     * @param to
     *            mongo {@link Document} to populate.
     ...
     * '{@value Constants#JOB_DATA}' field. Otherwise, first reads a plain object from
     * '{@value Constants#JOB_DATA_PLAIN}' field, or, if not present, falls back to {@code base64} field.
     *
     * @param from
     *            mongo {@link Document} to read from.
     * @param to
     *            {@link JobDataMap} to populate.
    ...
    /**
     * Converts from document to job data map reading {@code base64} encoded field '{@value Constants#JOB_DATA}'.
     */
    ...
    /**
     * Converts from document to job data map reading a plain object from field '{@value Constants#JOB_DATA_PLAIN}'.
     */
