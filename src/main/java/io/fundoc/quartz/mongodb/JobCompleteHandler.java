...
public class JobCompleteHandler {
    ...
    public JobCompleteHandler(TriggerAndJobPersister persister, SchedulerSignaler signaler, JobDao jobDao,
            LocksDao locksDao, TriggerDao triggerDao) {
    ...
    public void jobComplete(OperableTrigger trigger,JobDetail job,CompletedExecutionInstruction executionInstruction) {
