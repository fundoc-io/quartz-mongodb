...
import io.fundoc.quartz.mongodb.dao.JobDao;
import io.fundoc.quartz.mongodb.dao.PausedJobGroupsDao;
import io.fundoc.quartz.mongodb.dao.PausedTriggerGroupsDao;
import io.fundoc.quartz.mongodb.dao.TriggerDao;
import io.fundoc.quartz.mongodb.util.GroupHelper;
import io.fundoc.quartz.mongodb.util.QueryHelper;
import io.fundoc.quartz.mongodb.util.TriggerGroupHelper;

public class TriggerStateManager {

    private final TriggerDao triggerDao;
    private final JobDao jobDao;
    private final PausedJobGroupsDao pausedJobGroupsDao;
    private final PausedTriggerGroupsDao pausedTriggerGroupsDao;
    private final QueryHelper queryHelper;

    public TriggerStateManager(TriggerDao triggerDao, JobDao jobDao, PausedJobGroupsDao pausedJobGroupsDao,
            PausedTriggerGroupsDao pausedTriggerGroupsDao, QueryHelper queryHelper) {
    ...
    private TriggerState getTriggerState(String value) {
        ...
        switch (value) {
            case Constants.STATE_DELETED :
                return TriggerState.NONE;
            case Constants.STATE_COMPLETE :
                return TriggerState.COMPLETE;
            case Constants.STATE_PAUSED :
            case Constants.STATE_PAUSED_BLOCKED :
