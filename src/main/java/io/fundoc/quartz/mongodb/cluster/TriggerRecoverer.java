package io.fundoc.quartz.mongodb.cluster;
...
import io.fundoc.quartz.mongodb.LockManager;
import io.fundoc.quartz.mongodb.TriggerAndJobPersister;
...
public class TriggerRecoverer {
    ...
    public TriggerRecoverer(LocksDao locksDao, TriggerAndJobPersister persister, LockManager lockManager,
            TriggerDao triggerDao, JobDao jobDao, RecoveryTriggerFactory recoveryTriggerFactory,
