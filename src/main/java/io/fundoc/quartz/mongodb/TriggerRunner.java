...
import io.fundoc.quartz.mongodb.cluster.TriggerRecoverer;
import io.fundoc.quartz.mongodb.dao.CalendarDao;
import io.fundoc.quartz.mongodb.dao.JobDao;
import io.fundoc.quartz.mongodb.dao.LocksDao;
...
public class TriggerRunner {
    ...
    private final TriggerRecoverer recoverer;
    ...
    public TriggerRunner(TriggerAndJobPersister persister, TriggerDao triggerDao, JobDao jobDao, LocksDao locksDao,
            CalendarDao calendarDao, MisfireHandler misfireHandler, TriggerConverter triggerConverter,
            LockManager lockManager, TriggerRecoverer recoverer) {
    ...
    private TriggerFiredBundle createTriggerFiredBundle(OperableTrigger trigger) throws JobPersistenceException {
        ...
        return new TriggerFiredBundle(retrieveJob(trigger), trigger, cal, isRecovering(trigger), new Date(),
