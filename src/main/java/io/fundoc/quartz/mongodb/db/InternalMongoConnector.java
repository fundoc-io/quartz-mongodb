...
public class InternalMongoConnector implements MongoConnector {
     ...
     *
     * @param writeConcern
     *            instance of {@link WriteConcern}. Each {@link MongoCollection} produced by
     *            {@link #getCollection(String)} will be configured with this write concern.
     * @param mongoClient
     *            {@link MongoClient} that we just created.
     * @param dbName
     *            name of the database that will be used to produce collections.
     */
     ...
     *             if failed to create instance of MongoClient.
     */
    public InternalMongoConnector(final WriteConcern writeConcern, final String uri, final String dbName)
            throws SchedulerConfigException {
     ...
     */
    public InternalMongoConnector(final WriteConcern writeConcern, final String uri, final String dbName,
            MongoClientSettings.Builder settingsBuilder) throws SchedulerConfigException {
     ...
     * @param credentials
     *            credentials used to authenticate all connections.
     * @param settingsBuilder
     *            default settings builder.
     * @param dbName
     *            name of the database that will be used to produce collections.
    ...
    public InternalMongoConnector(final WriteConcern writeConcern, final List<ServerAddress> seeds,
            final Optional<MongoCredential> credentials, final MongoClientSettings.Builder settingsBuilder,
    ...
    private static MongoClient createClient(final String uri,final MongoClientSettings.Builder settingsBuilder)
            throws SchedulerConfigException {
     ...
     */
    private static MongoClient createClient(final List<ServerAddress> seeds,final Optional<MongoCredential> credentials,
